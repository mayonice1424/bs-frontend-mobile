          ...
          <View>
            {
              satuan.map((item, index) => {
                return(
                  <View key={index}>
                    <Text style={[colorStyle.blackForFontAndAnything,textStyle.innerTeks,{marginVertical:20}]}>{item.namaSatuan}</Text>
                    {
              ...
              <View style={
                {flexDirection:'column',justifyContent:'space-between',marginVertical:20}
              }>
                <Text style = {[
